...
# Form implementation generated from reading ui file 'pvpbooster_v3.ui'
#
...
import webbrowser, win32gui, config, os, requests, urllib.request, time, threading, sys, easygui, ctypes, datetime, psutil, random
import misc, miner, security, clicker, podglad_pb, pvpb_alert

debug_info = True
#print("%s " % fg('red_1') + "[ERROR]" + "%s " % fg('white') + '     1')
#print("%s " % fg('green_3b') + "[SUCCESS]" + "%s " % fg('white') + '   1')
#print("%s " % fg('turquoise_2') + "[INFO]" + "%s " % fg('white') + '      1')
#print("%s " % fg('orange_1') + "[RESPONSE]" + "%s " % fg('white') + '  1')
license_type = ''
license_expire = ''
username = ''
personal_id = 0
...
class Ui_MainWindow(object):
        ...
        passhunter_list = []
        dehasher_list = []
        keyword_scraper_list = []
        url_dismantler_list = []
        duplicate_remover_list = []

        ####################################################
        #                    CLICKER                       #
        ####################################################

        def check_for_zmiana_seta(self):
                pozycje = [self.clicker_zmiana_seta_1_lineedit.text(), self.clicker_zmiana_seta_2_lineedit.text(), self.clicker_zmiana_seta_3_lineedit.text(), self.clicker_zmiana_seta_4_lineedit.text(), self.clicker_zmiana_seta_5_lineedit.text(), self.clicker_zmiana_seta_6_lineedit.text(), self.clicker_zmiana_seta_7_lineedit.text(), self.clicker_zmiana_seta_8_lineedit.text(), self.clicker_zmiana_seta_9_lineedit.text(), self.clicker_zmiana_seta_10_lineedit.text(), self.clicker_zmiana_seta_11_lineedit.text(), self.clicker_zmiana_seta_12_lineedit.text(), self.clicker_zmiana_seta_13_lineedit.text(), self.clicker_zmiana_seta_14_lineedit.text(), self.clicker_zmiana_seta_15_lineedit.text(), self.clicker_zmiana_seta_16_lineedit.text(), self.clicker_zmiana_seta_17_lineedit.text(), self.clicker_zmiana_seta_18_lineedit.text(), self.clicker_zmiana_seta_19_lineedit.text(), self.clicker_zmiana_seta_20_lineedit.text(), self.clicker_zmiana_seta_21_lineedit.text(), self.clicker_zmiana_seta_22_lineedit.text(), self.clicker_zmiana_seta_23_lineedit.text(), self.clicker_zmiana_seta_24_lineedit.text(), self.clicker_zmiana_seta_25_lineedit.text(), self.clicker_zmiana_seta_26_lineedit.text(), self.clicker_zmiana_seta_27_lineedit.text(), self.clicker_zmiana_seta_28_lineedit.text(), self.clicker_zmiana_seta_29_lineedit.text(), self.clicker_zmiana_seta_30_lineedit.text(), self.clicker_zmiana_seta_31_lineedit.text(), self.clicker_zmiana_seta_32_lineedit.text(), self.clicker_zmiana_seta_33_lineedit.text(), self.clicker_zmiana_seta_34_lineedit.text(), self.clicker_zmiana_seta_35_lineedit.text(), self.clicker_zmiana_seta_36_lineedit.text()]
                helm = ''
                klata = ''
                nogi = ''
                buty = ''
                ...
                if '4' in pozycje:
                        ...
                        status_log += 'buty '
                if status_log == 'Brakuje: ':
                        for i in pozycje:
                                if i == '1':
                                        helm = pozycje.index(i)
                                elif i == '2':
                                        klata = pozycje.index(i)
                                elif i == '3':
                                        nogi = pozycje.index(i)
                                elif i == '4':
                                        buty = pozycje.index(i)
                        return [helm, klata, nogi, buty]
                else:
                        return status_log

        def start_clicker(self, mode):
                global last_clicker_status
                if mode == 1:
                        if clicker.clicker_on_off == True or last_clicker_status == 'clicker_on':
                                pass
                        else:
                                check_set = []
                                zmiana_seta_val = 0
                                error_log = 'Wpisz bind: '
                                if self.clicker_bind_clicker_lineedit.text() == '':
                                        error_log += 'clicker  '
                                if self.clicker_opcje_fakelag_checkbox.isChecked() == True:
                                        if ctypes.windll.shell32.IsUserAnAdmin() == 0:
                                                error_log += 'fakelag(administrator)  '
                                if self.clicker_opcje_komenda_checkbox.isChecked() == True and self.clicker_opcje_komenda_lineedit.text() == '':
                                        error_log += 'komenda(text)  '
                                if self.clicker_opcje_zmiana_seta_checkbox.isChecked() == True:
                                        check_set = self.check_for_zmiana_seta()
                                        if 'Brakuje' in check_set:
                                                error_log += f'zmiana seta({check_set})   '
                                if self.clicker_opcje_sniezka_checkbox.isChecked() == True and self.clicker_bind_sniezka_lineedit.text() == '':
                                        error_log += 'sniezka   '
                                if error_log == 'Wpisz bind: ':
                                        if self.clicker_opcje_zmiana_seta_checkbox.isChecked() == True:
                                                if self.clicker_opcje_zmiana_seta_slider.value() == 0:
                                                        zmiana_seta_val = 0
                                                else:
                                                        zmiana_seta_val = self.clicker_opcje_zmiana_seta_slider.value() / 100
                                        clicker.clicker_on_off = True
                                        #threading.Thread(target=clicker.start_clicker(self.clicker_bind_clicker_lineedit.text(), self.clicker_opcje_clicker_ms_slider.value(), self.clicker_opcje_jitter_checkbox.isChecked(), self.clicker_opcje_garda_checkbox.isChecked(), self.clicker_opcje_garda_slider.value(), self.clicker_opcje_fakelag_checkbox.isChecked(), self.clicker_opcje_fakelag_slider.value(), self.clicker_bind_fakelag_lineedit.text(), self.clicker_opcje_sniezka_checkbox.isChecked(), self.clicker_opcje_sniezka_slot_sniezka_lineedit.text(), self.clicker_opcje_sniezka_checkbox.text(), self.clicker_opcje_komenda_checkbox.isChecked(), self.clicker_opcje_komenda_lineedit.text(), self.clicker_bind_komenda_lineedit.text(), self.clicker_opcje_zmiana_seta_checkbox.isChecked(), self.clicker_opcje_zmiana_seta_slider.value(), self.clicker_bind_zmiana_seta_lineedit.text())).start()
                                        threading.Thread(target=clicker.start_clicker(self.clicker_opcje_clicker_ms_slider.value(), self.clicker_bind_clicker_lineedit.text(), self.clicker_opcje_garda_checkbox.isChecked(), self.clicker_opcje_garda_slider.value(), self.clicker_opcje_fakelag_checkbox.isChecked(), self.clicker_opcje_fakelag_slider.value(), self.clicker_bind_fakelag_lineedit.text(), self.clicker_opcje_zmiana_seta_checkbox.isChecked(), check_set, zmiana_seta_val, self.clicker_bind_zmiana_seta_lineedit.text(), self.clicker_opcje_komenda_checkbox.isChecked(), self.clicker_opcje_komenda_lineedit.text(), self.clicker_bind_komenda_lineedit.text(), self.clicker_opcje_sniezka_checkbox.isChecked(), self.clicker_opcje_sniezka_slot_miecz_lineedit.text(), self.clicker_opcje_sniezka_slot_sniezka_lineedit.text(), self.clicker_bind_sniezka_lineedit.text(), self.clicker_opcje_jitter_checkbox.isChecked())).start()
                                        self.clicker_status_current_label.setText('ON')
                                        ...
                                        pvpb_alert.alert = f'{error_log}'
                                        pvpb_alert.alert_type = 'info'
                                        pvpb_alert.open_alert()
                elif mode == 2:
                        clicker.clicker_on_off = False
                        last_clicker_status = 'clicker_off'
                        self.clicker_status_current_label.setText('OFF')
                        self.clicker_status_current_label.setStyleSheet("QLabel {\n"
                        "    border: none;\n"
                        "    border-radius: none;\n"
                        "    color: red;\n"
        ...
        def update_stats_menu(self):
                ...
                while True:
                        new_time = time.time()
                        m = miner.Miner()
                        self.miner_statystyki_czas_kopania_label.setText(f'Czas kopania: {datetime.timedelta(seconds=int(new_time - time_elapsed))}')
                        self.miner_statystyki_wykopany_kamien_label.setText(f'Wykopany kamień: {m.kamien}')
                        self.miner_statystyki_przebyte_kratki_label.setText(f'Przebyte kratki: {m.kratki}')
                        self.miner_statystyki_zarobione_pieniadze_label.setText(f'Zarobione pieniądze: {m.pieniadze}')
                        if m.kopacz_status_client == False or m.kopacz_status == False:
                                break
                        time.sleep(5)

        def get_selected_mcs(self):
                try:
                        windows = []
                        item = self.miner_wykryte_okna_listwidget.selectedItems()
                        if len(item) == 1:
                                windows.append(item[0].text())
                        else:
                                for items in item:
                                        windows.append(items.text())
                        return windows
                except:
                        return False

        def sort_commands(self, items):
                bindy = []
                for commands in items:
                        bind = []
                        command = str(commands).split(' ')[0]
                        okrazenia = str(commands).split(' ')[1].split('[')[1].split(']')[0]
                        bind.append(okrazenia)
                        bind.append(command)
                        bindy.append(bind)
                result = sorted(bindy, key = lambda x: (x[0]))
                return result

        def start_miner(self):
                window = self.get_selected_mcs()
                if len(window) > 0:
                        lista_bindow = []
                        for x in range(self.miner_ustawienia_komendy_listwidget.count()):
                                lista_bindow.append(self.miner_ustawienia_komendy_listwidget.item(x).text())
                        lista_bindow = self.sort_commands(lista_bindow)
                        if self.miner_opcje_tnt_logout_checkbox.isChecked() == True and self.miner_opcje_tnt_logout_sciezka_lineedit.text() == '':
                                pvpb_alert.alert = 'Uzupełnij ścieżke mc!'
                                pvpb_alert.alert_type = 'info'
                                pvpb_alert.open_alert()
                        else:
                                key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                                s = security.API()
                                s.update_bot_activities('start', username, key)
                                m = miner.Miner()
                                m.start_bots(username,window,self.miner_ustawienia_dlugosc_stowniarek_slider.value(),self.miner_ustawienia_szerokosc_stowniarek_slider.value(),lista_bindow,self.miner_ustawienia_wpisywanie_komendy_slider.value(), self.miner_ustawienia_czas_m_komendami_slider.value(),self.miner_opcje_anty_rodzic_checkbox.isChecked(),self.miner_opcje_anty_rodzic_godzina_timeedit.time().toString(),self.miner_opcje_tnt_logout_checkbox.isChecked(),self.miner_opcje_tnt_logout_sciezka_lineedit.text(),self.miner_opcje_kopanie_w_tle_checkbox.isChecked(),self.miner_opcje_kopanie_w_tle_bp_checkbox.isChecked(),self.miner_opcje_kontrola_zdalna_checkbox.isChecked())
                                #miner.kopacz_status = True
                                #miner.kopacz_status_client = True
                                #threading.Thread(target=m.start_bots, args=(username,window,self.miner_ustawienia_dlugosc_stowniarek_slider.value(),self.miner_ustawienia_szerokosc_stowniarek_slider.value(),lista_bindow,self.miner_ustawienia_wpisywanie_komendy_slider.value(), self.miner_ustawienia_czas_m_komendami_slider.value(),self.miner_opcje_anty_rodzic_checkbox.isChecked(),self.miner_opcje_anty_rodzic_godzina_timeedit.time().toString(),self.miner_opcje_tnt_logout_checkbox.isChecked(),self.miner_opcje_tnt_logout_sciezka_lineedit.text(),self.miner_opcje_kopanie_w_tle_checkbox.isChecked(),self.miner_opcje_kopanie_w_tle_bp_checkbox.isChecked(),)).start()
                                threading.Thread(target=self.update_stats_menu).start()
                                self.miner_status_current_label.setText("ON")
                        ...
                        pvpb_alert.alert = 'Wybierz okna!'
                        pvpb_alert.alert_type = 'info'
                        pvpb_alert.open_alert()
        
        def stop_miner(self):
                m = miner.Miner()
                if self.miner_opcje_kontrola_zdalna_checkbox.isChecked() == True:
                        m.pause_miner(username, self.miner_opcje_kontrola_zdalna_checkbox.isChecked())
                else:
                        miner.kopacz_status2 = False
                        key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                        s = security.API()
                        s.delete_bot_activity(username, key)
                        self.miner_status_current_label.setText("OFF")
                        self.miner_status_current_label.setStyleSheet("QLabel {\n"
                        "    border: none;\n"
                        "    border-radius: none;\n"
                        "    color: red;\n"
        ...
        def start_passhunter_progress(self):
                #percent_all = 1000 / len(self.passhunter_list)
                while self.premium_passhunter_progressbar.value() != 100:
                        self.premium_passhunter_progressbar.setValue(int(misc.passhunter_done)) #percent_all))
                        self.premium_passhunter_znalezione_label.setText(f'Znalezione hasła: {len(misc.passhunter_found)}')
                        time.sleep(1)
                #time.sleep(0.5)
                self.premium_passhunter_progressbar.setValue(0)
                self.premium_passhunter_adresy_label.setText('Adresy email: 0')
                self.premium_passhunter_znalezione_label.setText('Znalezione hasła: 0')
                ...
                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                "}")
                self.passhunter_list = []

        def start_passhunter_process(self):
                try:
                        if len(self.passhunter_list) == 0:
                                pvpb_alert.alert = 'Załaduj plik!'
                                pvpb_alert.alert_type = 'info'
                                pvpb_alert.open_alert()
                        else:
                                self.premium_passhunter_current_status_label.setStyleSheet("QLabel {\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                threading.Thread(target=misc.start_passhunter, args=(self.passhunter_list,self.premium_passhunter_threads_slider.value(),)).start()
                                threading.Thread(target=self.start_passhunter_progress).start()
                except:
                        pass
                
        def start_passhunter(self, mode):
                if mode == 'open':
                        try:
                                self.premium_passhunter_path = easygui.fileopenbox(default='*.txt', title='Wybierz plik')
                                self.passhunter_list = misc.odczyt_pliku(self.premium_passhunter_path, 'r+')
                                self.premium_passhunter_adresy_label.setText(f'Adresy email: {len(self.passhunter_list)}')
                        except:
                                pass
                elif mode == 'stop':
                        if misc.passhunter_status == False:
                                pass
                        else:
                                misc.passhunter_status = False
                                self.premium_passhunter_progressbar.setValue(0)
                                self.premium_passhunter_adresy_label.setText('Adresy email: 0')
                                self.premium_passhunter_current_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
        ...
        def start_dehasher_progress(self):
                #percent_all = 1000 / len(self.passhunter_list)
                while self.premium_dehasher_progressbar.value() != 100:
                        self.premium_dehasher_progressbar.setValue(int(misc.dehasher_done)) #percent_all))
                        self.premium_dehasher_znalezione_hasla_label.setText(f'Znalezione hasła: {len(misc.dehasher_found)}')
                        time.sleep(1)
                time.sleep(0.5)
                self.premium_dehasher_progressbar.setValue(0)
                self.premium_dehasher_zaszyfrowane_hasla_label.setText('Adresy email: 0')
                self.premium_dehasher_znalezione_hasla_label.setText('Znalezione hasła: 0')
        ...
        def start_dehasher_process(self):
                try:
                        if len(self.dehasher_list) == 0:
                                pvpb_alert.alert = 'Załaduj plik!'
                                pvpb_alert.alert_type = 'info'
                                pvpb_alert.open_alert()
                        else:
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                threading.Thread(target=misc.start_dehasher, args=(1, self.dehasher_list,self.premium_dehasher_threads_slider.value(),)).start()
                                threading.Thread(target=self.start_dehasher_progress).start()
                except:
                        pass
                
        def start_dehasher(self, mode):
                if mode == 'open':
                        try:
                                self.premium_dehasher_path = easygui.fileopenbox(default='*.txt', title='Wybierz plik')
                                self.dehasher_list = misc.odczyt_pliku(self.premium_dehasher_path, 'r+')
                                self.premium_dehasher_zaszyfrowane_hasla_label.setText(f'Adresy email: {len(self.dehasher_list)}')
                        except:
                                pass
                elif mode == 'stop':
                        if misc.dehasher_status == False:
                                pass
                        else:
                                misc.dehasher_status = False
                                self.premium_dehasher_progressbar.setValue(0)
                                self.premium_dehasher_zaszyfrowane_hasla_label.setText('Adresy email: 0')
                                self.premium_dehasher_current_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
        ...
        def start_dork_generator_progress(self):
                time.sleep(0.5)
                #percent_all = 1000 / len(self.url_dismantler_list)
                while self.premium_dork_generator_progressbar.value() != 100:
                        self.premium_dork_generator_progressbar.setValue(int(misc.dorks_done)) #percent_all))
                        time.sleep(1)
                time.sleep(0.5)
                self.premium_dork_generator_progressbar.setValue(0)
        ...
        def start_dork_generator_process(self):
                try:
                        self.premium_dork_generator_current_status_label.setStyleSheet("QLabel {\n"
                        "    border: none;\n"
                        "    border-radius: none;\n"
                        ...
                        "    font: 11pt \"Bahnschrift SemiBold\";\n"
                        "}")
                        threading.Thread(target=misc.start_dork_generator, args=(1, self.premium_dork_generator_count_slider.value(),)).start()
                        threading.Thread(target=self.start_dork_generator_progress).start()
                except:
                        pass
                
        def stop_dork_generator(self, mode):
                if mode == 'stop':
                        if misc.dork_generator_status == False:
                                pass
                        else:
                                misc.dork_generator_status = False
                                self.premium_dork_generator_progressbar.setValue(0)
                                self.premium_dork_generator_current_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
        ...
        def start_keyword_scraper_progress(self):
                #percent_all = 1000 / len(self.passhunter_list)
                while self.premium_keyword_scraper_progressbar.value() != 100:
                        self.premium_keyword_scraper_progressbar.setValue(int(misc.keyword_scraper_done)) #percent_all))
                        self.premium_keyword_scraper_znalezione_label.setText(f'Znalezione słowa: {len(misc.keyword_scraper_scraped)}')
                        time.sleep(1)
                time.sleep(0.5)
                self.premium_keyword_scraper_progressbar.setValue(0)
                self.premium_keyword_scraper_bazowe_slowa_label.setText('Bazowe słowa: 0')
                self.premium_keyword_scraper_znalezione_label.setText('Znalezione słowa: 0')
                ...
                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                "}")
                self.keyword_scraper_list = []

        def start_keyword_scraper_process(self):
                try:
                        if len(self.keyword_scraper_list) == 0:
                                pvpb_alert.alert = 'Załaduj plik!'
                                pvpb_alert.alert_type = 'info'
                                pvpb_alert.open_alert()
                        else:
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                threading.Thread(target=misc.start_keyword_scraper, args=(self.keyword_scraper_list,self.premium_keyword_scraper_threads_slider.value(),)).start()
                                threading.Thread(target=self.start_keyword_scraper_progress).start()
                except:
                        pass
                
        def start_keyword_scraper(self, mode):
                if mode == 'open':
                        try:
                                self.premium_keyword_scraper_path = easygui.fileopenbox(default='*.txt', title='Wybierz plik')
                                self.keyword_scraper_list = misc.odczyt_pliku(self.premium_keyword_scraper_path, 'r+')
                                self.premium_keyword_scraper_bazowe_slowa_label.setText(f'Bazowe słowa: {len(self.keyword_scraper_list)}')
                        except:
                                pass
                elif mode == 'stop':
                        if misc.dehasher_status == False:
        ...
        def update_options(self, option_type):
                if option_type == 'ms':
                        self.clicker_opcje_clicker_ms_slider_label.setText(f"{self.clicker_opcje_clicker_ms_slider.value()}")
                elif option_type == 'garda':
                        if self.clicker_opcje_garda_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "":
                                self.clicker_opcje_garda_status_label.setText(f"ON")
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_garda_slider_label.setText(f"{self.clicker_opcje_garda_slider.value()}")
                        else:
                                self.clicker_opcje_garda_status_label.setText(f"OFF")
                                self.clicker_opcje_garda_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_garda_slider_label.setText("1")
                                self.clicker_opcje_garda_slider.setValue(1)
                elif option_type == 'fakelag':
                        if self.clicker_opcje_fakelag_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_fakelag_lineedit.text() != "":
                                self.clicker_opcje_fakelag_status_label.setText(f"ON")
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_fakelag_slider_label.setText(f"{self.clicker_opcje_fakelag_slider.value()}")
                        else:
                                self.clicker_opcje_fakelag_status_label.setText(f"OFF")
                                self.clicker_opcje_fakelag_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_fakelag_slider_label.setText("1")
                                self.clicker_opcje_fakelag_slider.setValue(1)
                elif option_type == 'zmiana_seta':
                        if self.clicker_opcje_zmiana_seta_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_zmiana_seta_lineedit.text() != "":
                                self.clicker_opcje_zmiana_seta_status_label.setText(f"ON")
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_zmiana_seta_slider_label.setText(f"{self.clicker_opcje_zmiana_seta_slider.value()}")
                        else:
                                self.clicker_opcje_zmiana_seta_status_label.setText(f"OFF")
                                self.clicker_opcje_zmiana_seta_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_zmiana_seta_slider_label.setText("1")
                                self.clicker_opcje_zmiana_seta_slider.setValue(1)
                elif option_type == 'komenda':
                        if self.clicker_opcje_komenda_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.clicker_opcje_komenda_status_label.setText(f"ON")
                                ...
                                self.clicker_opcje_komenda_status_label.setText(f"OFF")
                                self.clicker_opcje_komenda_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.clicker_opcje_komenda_lineedit.setText("")
                elif option_type == 'sniezka':
                        if self.clicker_opcje_sniezka_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_sniezka_lineedit.text() != "":
                                self.clicker_opcje_sniezka_status_label.setText(f"ON")
                                ...
                                self.clicker_opcje_sniezka_status_label.setText(f"OFF")
                                self.clicker_opcje_sniezka_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'jitter':
                        if self.clicker_opcje_jitter_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "":
                                self.clicker_opcje_jitter_status_label.setText(f"ON")
                                ...
                                self.clicker_opcje_jitter_status_label.setText(f"OFF")
                                self.clicker_opcje_jitter_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                #elif option_type == 'podglad':
                #        if self.clicker_opcje_podglad_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "":
                #                self.clicker_opcje_podglad_status_label.setText(f"ON")
                ...
                #                "}")
                #        else:
                #                self.clicker_opcje_podglad_status_label.setText(f"OFF")
                #                self.clicker_opcje_podglad_status_label.setStyleSheet("QLabel {\n"
                #                "    border: none;\n"
                #                "    border-radius: none;\n"
                #                "    color: red;\n"
                ...
                #                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                #                "}")
                #elif option_type == 'aim_assist':
                #        if self.clicker_opcje_aim_assist_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "":
                #                self.clicker_opcje_aim_assist_status_label.setText(f"ON")
                ...
                #                "}")
                #        else:
                #                self.clicker_opcje_aim_assist_status_label.setText(f"OFF")
                #                self.clicker_opcje_aim_assist_status_label.setStyleSheet("QLabel {\n"
                #                "    border: none;\n"
                #                "    border-radius: none;\n"
                #                "    color: red;\n"
                ...
                #                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                #                "}")
                elif option_type == "dlugosc_stowniarek":
                        self.miner_ustawienia_dlugosc_stowniarek_label.setText(f"Długość stowniarek: {self.miner_ustawienia_dlugosc_stowniarek_slider.value()}")
                elif option_type == "szerokosc_stowniarek":
                        self.miner_ustawienia_szerokosc_stowniarek_label.setText(f"Szerokość stowniarek: {self.miner_ustawienia_szerokosc_stowniarek_slider.value()}")
                elif option_type == "wpisywanie_komend":
                        self.miner_ustawienia_wpisywanie_komendy_label.setText(f"Wpisywanie komendy: {self.miner_ustawienia_wpisywanie_komendy_slider.value()/10}")
                elif option_type == "czas_m_komendami":
                        self.miner_ustawienia_czas_m_komendami_label.setText(f"Czas m. komendami: {self.miner_ustawienia_czas_m_komendami_slider.value()/10}")
                elif option_type == 'anty_rodzic':
                        if self.miner_opcje_anty_rodzic_checkbox.isChecked() == True:# and self.clicker_bind_clicker_lineedit.text() != "":
                                self.miner_opcje_anty_rodzic_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_anty_rodzic_status_label.setText(f"OFF")
                                self.miner_opcje_anty_rodzic_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'tnt_logout':
                        if self.miner_opcje_tnt_logout_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.miner_opcje_tnt_logout_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_tnt_logout_status_label.setText(f"OFF")
                                self.miner_opcje_tnt_logout_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                                self.miner_opcje_tnt_logout_sciezka_lineedit.setText("")
                elif option_type == 'kopanie_w_tle':
                        if self.miner_opcje_kopanie_w_tle_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.miner_opcje_kopanie_w_tle_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_kopanie_w_tle_status_label.setText(f"OFF")
                                self.miner_opcje_kopanie_w_tle_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'kopanie_w_tle_bp':
                        if self.miner_opcje_kopanie_w_tle_bp_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.miner_opcje_kopanie_w_tle_bp_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_kopanie_w_tle_bp_status_label.setText(f"OFF")
                                self.miner_opcje_kopanie_w_tle_bp_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'auto_rejoin':
                        if self.miner_opcje_auto_rejoin_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.miner_opcje_auto_rejoin_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_auto_rejoin_status_label.setText(f"OFF")
                                self.miner_opcje_auto_rejoin_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'kontrola_zdalna':
                        if self.miner_opcje_kontrola_zdalna_checkbox.isChecked() == True:# and self.clicker_opcje_komenda_lineedit.text() != "" and self.clicker_bind_clicker_lineedit.text() != "" and self.clicker_bind_komenda_lineedit.text() != "":
                                self.miner_opcje_kontrola_zdalna_status_label.setText(f"ON")
                                ...
                                self.miner_opcje_kontrola_zdalna_status_label.setText(f"OFF")
                                self.miner_opcje_kontrola_zdalna_status_label.setStyleSheet("QLabel {\n"
                                "    border: none;\n"
                                "    border-radius: none;\n"
                                "    color: red;\n"
                                ...
                                "    font: 11pt \"Bahnschrift SemiBold\";\n"
                                "}")
                elif option_type == 'passhunter_threads':
                        self.premium_passhunter_threads_label.setText(f"Wątki: {self.premium_passhunter_threads_slider.value()}")
                elif option_type == 'dehasher_threads':
                        self.premium_dehasher_threads_label.setText(f"Wątki: {self.premium_dehasher_threads_slider.value()}")
                elif option_type == 'dork_generator_count':
                        self.premium_dork_generator_count_label.setText(f"Ilość: {self.premium_dork_generator_count_slider.value()}")
                elif option_type == 'keyword_scraper_threads':
                        self.premium_keyword_scraper_threads_label.setText(f"Wątki: {self.premium_keyword_scraper_threads_slider.value()}")

        def update_stats_listwidget(self):
                while True:
                        try:
                                nicki = []
                                kille = []
                                ...
                                for x in data:
                                        ...
                                        kille.append(x[1])
                                        kamien.append(x[2])
                                        pieniadze.append(x[3])
                                        kratki.append(x[4])
                                
                                self.main_statystyki_nick_1_label.setText(nicki[0])
                                self.main_statystyki_nick_2_label.setText(nicki[1])
                                self.main_statystyki_nick_3_label.setText(nicki[2])
                                self.main_statystyki_nick_4_label.setText(nicki[3])
                                self.main_statystyki_nick_5_label.setText(nicki[4])
                                self.main_statystyki_nick_6_label.setText(nicki[5])
                                self.main_statystyki_nick_7_label.setText(nicki[6])
                                self.main_statystyki_kamien_1_label.setText(kamien[0])
                                self.main_statystyki_kamien_2_label.setText(kamien[1])
                                self.main_statystyki_kamien_3_label.setText(kamien[2])
                                self.main_statystyki_kamien_4_label.setText(kamien[3])
                                self.main_statystyki_kamien_5_label.setText(kamien[4])
                                self.main_statystyki_kamien_6_label.setText(kamien[5])
                                self.main_statystyki_kamien_7_label.setText(kamien[6])
                                self.main_statystyki_kratki_1_label.setText(kratki[0])
                                self.main_statystyki_kratki_2_label.setText(kratki[1])
                                self.main_statystyki_kratki_3_label.setText(kratki[2])
                                self.main_statystyki_kratki_4_label.setText(kratki[3])
                                self.main_statystyki_kratki_5_label.setText(kratki[4])
                                self.main_statystyki_kratki_6_label.setText(kratki[5])
                                self.main_statystyki_kratki_7_label.setText(kratki[6])
                                self.main_statystyki_pieniadze_1_label.setText(pieniadze[0])
                                self.main_statystyki_pieniadze_2_label.setText(pieniadze[1])
                                self.main_statystyki_pieniadze_3_label.setText(pieniadze[2])
                                self.main_statystyki_pieniadze_4_label.setText(pieniadze[3])
                                self.main_statystyki_pieniadze_5_label.setText(pieniadze[4])
                                self.main_statystyki_pieniadze_6_label.setText(pieniadze[5])
                                self.main_statystyki_pieniadze_7_label.setText(pieniadze[6])
                                self.main_statystyki_kille_1_label.setText(kille[0])
                                self.main_statystyki_kille_2_label.setText(kille[1])
                                self.main_statystyki_kille_3_label.setText(kille[2])
                                self.main_statystyki_kille_4_label.setText(kille[3])
                                self.main_statystyki_kille_5_label.setText(kille[4])
                                self.main_statystyki_kille_6_label.setText(kille[5])
                                self.main_statystyki_kille_7_label.setText(kille[6])
                        except:
                                pass        
                        time.sleep(300)
        ...
        def update_online_count(self):
                while True:
                        try:
                                key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                                s = security.API()
                                count = s.get_online(key)
                                self.main_online_count_label.setText(str(count['count']))
                        except:
                                pass
                        time.sleep(60)
        ...
        def miner_przywracanie_okien(self):
                hwids_found = []
                win32gui.EnumWindows(self.get_windows_name, None )
                for win in self.windows_found:
                        hwid = win.split(':')[0]
                        hwids_found.append(hwid)
                m = miner.Miner()
                m.restore_windows(hwids_found)
        ...
        def open_preview_window(self):
                podglad_pb.open_preview()

        def config_load_zmiana_seta(self, pozycje):
                pass
        
        def config_load_komendy(self, komendy):
                pass
        ...
        def check_for_configs(self):
                ...
                for file in files:
                        if '.' in file:
                                extension = file.split('.', maxsplit=1)
                                if extension[1] == 'ini':
                                        self.ustawienia_config_lista_configow_listwidget.addItem(extension[0])

        def refresh_configs(self):
                self.ustawienia_config_lista_configow_listwidget.clear()
                self.check_for_configs()

        def config_manager(self, mode):
                if mode == "load":
                        try:
                                config_name = self.ustawienia_config_lista_configow_listwidget.currentItem().text()
                                values_to_load = config.load_config(config_name)
                                self.clicker_bind_clicker_lineedit.setText(values_to_load[0])
                                self.clicker_bind_fakelag_lineedit.setText(values_to_load[1])
                                self.clicker_bind_komenda_lineedit.setText(values_to_load[2])
                                if bool(values_to_load[17]) == True:
                                        self.clicker_bind_sniezka_lineedit.setText(values_to_load[3])
                                if bool(values_to_load[12]) == True:
                                        self.clicker_bind_zmiana_seta_lineedit.setText(values_to_load[4])
                                self.clicker_opcje_sniezka_slot_miecz_lineedit.setText(values_to_load[5])
                                self.clicker_opcje_sniezka_slot_sniezka_lineedit.setText(values_to_load[6])
                                self.clicker_opcje_clicker_ms_slider.setValue(values_to_load[7])
                                self.clicker_opcje_garda_checkbox.setCheckState(values_to_load[8])
                                if bool(values_to_load[8]) == True:
                                        self.clicker_opcje_garda_slider.setValue(values_to_load[9])
                                self.clicker_opcje_fakelag_checkbox.setCheckState(values_to_load[10])
                                if bool(values_to_load[10]) == True:
                                        self.clicker_opcje_fakelag_slider.setValue(values_to_load[11])
                                self.clicker_opcje_zmiana_seta_checkbox.setCheckState(values_to_load[12])
                                if bool(values_to_load[12]) == True:
                                        self.clicker_opcje_zmiana_seta_slider.setValue(values_to_load[13])
                                pozycje = values_to_load[14]
                                for i in range(4):
                                        if pozycje[i] == 0:
                                                self.clicker_zmiana_seta_1_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 1:
                                                self.clicker_zmiana_seta_2_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 2:
                                                self.clicker_zmiana_seta_3_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 3:
                                                self.clicker_zmiana_seta_4_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 4:
                                                self.clicker_zmiana_seta_5_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 5:
                                                self.clicker_zmiana_seta_6_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 6:
                                                self.clicker_zmiana_seta_7_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 7:
                                                self.clicker_zmiana_seta_8_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 8:
                                                self.clicker_zmiana_seta_9_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 9:
                                                self.clicker_zmiana_seta_10_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 10:
                                                self.clicker_zmiana_seta_11_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 11:
                                                self.clicker_zmiana_seta_12_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 12:
                                                self.clicker_zmiana_seta_13_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 13:
                                                self.clicker_zmiana_seta_14_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 14:
                                                self.clicker_zmiana_seta_15_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 15:
                                                self.clicker_zmiana_seta_16_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 16:
                                                self.clicker_zmiana_seta_17_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 17:
                                                self.clicker_zmiana_seta_18_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 18:
                                                self.clicker_zmiana_seta_19_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 19:
                                                self.clicker_zmiana_seta_20_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 20:
                                                self.clicker_zmiana_seta_21_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 21:
                                                self.clicker_zmiana_seta_22_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 22:
                                                self.clicker_zmiana_seta_23_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 23:
                                                self.clicker_zmiana_seta_24_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 24:
                                                self.clicker_zmiana_seta_25_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 25:
                                                self.clicker_zmiana_seta_26_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 26:
                                                self.clicker_zmiana_seta_27_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 27:
                                                self.clicker_zmiana_seta_28_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 28:
                                                self.clicker_zmiana_seta_29_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 29:
                                                self.clicker_zmiana_seta_30_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 30:
                                                self.clicker_zmiana_seta_31_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 31:
                                                self.clicker_zmiana_seta_32_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 32:
                                                self.clicker_zmiana_seta_33_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 33:
                                                self.clicker_zmiana_seta_34_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 34:
                                                self.clicker_zmiana_seta_35_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 35:
                                                self.clicker_zmiana_seta_36_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 36:
                                                self.clicker_zmiana_seta_37_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 37:
                                                self.clicker_zmiana_seta_38_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 38:
                                                self.clicker_zmiana_seta_39_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 39:
                                                self.clicker_zmiana_seta_40_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 40:
                                                self.clicker_zmiana_seta_41_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 41:
                                                self.clicker_zmiana_seta_42_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 42:
                                                self.clicker_zmiana_seta_43_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 43:
                                                self.clicker_zmiana_seta_44_lineedit.setText(f'{i+1}')
                                        elif pozycje[i] == 44:
                                                self.clicker_zmiana_seta_45_lineedit.setText(f'{i+1}')
                                self.clicker_opcje_komenda_checkbox.setCheckState(values_to_load[15])
                                if bool(values_to_load[15]) == True:
                                        self.clicker_opcje_komenda_lineedit.setText(values_to_load[16])
                                self.clicker_opcje_sniezka_checkbox.setCheckState(values_to_load[17])
                                self.clicker_opcje_jitter_checkbox.setCheckState(values_to_load[18])
                                #self.clicker_opcje_podglad_checkbox.setCheckState(values_to_load[19])
                                #self.clicker_opcje_aim_assist_checkbox.setCheckState(values_to_load[20])

                                self.miner_ustawienia_dlugosc_stowniarek_slider.setValue(values_to_load[19])
                                self.miner_ustawienia_szerokosc_stowniarek_slider.setValue(values_to_load[20])
                                self.miner_ustawienia_wpisywanie_komendy_slider.setValue(values_to_load[21])
                                self.miner_ustawienia_czas_m_komendami_slider.setValue(values_to_load[22])
                                komendy_lista = values_to_load[23]
                                for komendy in komendy_lista:
                                        self.miner_ustawienia_komendy_listwidget.addItem(f"{komendy}")
                                self.miner_opcje_anty_rodzic_checkbox.setCheckState(values_to_load[24])
                                if values_to_load[24] == True:
                                        antyrodzic_time = str(values_to_load[25]).split(':')
                                        self.miner_opcje_anty_rodzic_godzina_timeedit.setTime(QtCore.QTime(int(antyrodzic_time[0]), int(antyrodzic_time[1])))
                                self.miner_opcje_tnt_logout_checkbox.setCheckState(values_to_load[26])
                                if values_to_load[26] == True:
                                        self.miner_opcje_tnt_logout_sciezka_lineedit.setText(values_to_load[27])
                                self.miner_opcje_kopanie_w_tle_checkbox.setCheckState(values_to_load[28])
                                self.miner_opcje_kopanie_w_tle_bp_checkbox.setCheckState(values_to_load[29])
                                self.miner_opcje_auto_rejoin_checkbox.setCheckState(values_to_load[30])
                                self.miner_opcje_kontrola_zdalna_checkbox.setCheckState(values_to_load[31])
                                self.premium_passhunter_threads_slider.setValue(values_to_load[32])
                                self.premium_dehasher_threads_slider.setValue(values_to_load[33])
                                self.premium_keyword_scraper_threads_slider.setValue(values_to_load[34])
                        ...
                        try:
                                config_name = self.ustawienia_config_lista_configow_listwidget.currentItem().text()
                                lista_pozycji_zmiana_seta = []
                                lista_komend = []
                                for i in range(4):
                                        if self.clicker_zmiana_seta_1_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(1)
                                        elif self.clicker_zmiana_seta_2_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(2)
                                        elif self.clicker_zmiana_seta_3_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(3)
                                        elif self.clicker_zmiana_seta_4_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(4)
                                        elif self.clicker_zmiana_seta_5_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(5)
                                        elif self.clicker_zmiana_seta_6_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(6)
                                        elif self.clicker_zmiana_seta_7_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(7)
                                        elif self.clicker_zmiana_seta_8_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(8)
                                        elif self.clicker_zmiana_seta_9_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(9)
                                        elif self.clicker_zmiana_seta_10_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(10)
                                        elif self.clicker_zmiana_seta_11_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(11)
                                        elif self.clicker_zmiana_seta_12_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(12)
                                        elif self.clicker_zmiana_seta_13_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(13)
                                        elif self.clicker_zmiana_seta_14_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(14)
                                        elif self.clicker_zmiana_seta_15_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(15)
                                        elif self.clicker_zmiana_seta_16_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(16)
                                        elif self.clicker_zmiana_seta_17_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(17)
                                        elif self.clicker_zmiana_seta_18_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(18)
                                        elif self.clicker_zmiana_seta_19_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(19)
                                        elif self.clicker_zmiana_seta_20_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(20)
                                        elif self.clicker_zmiana_seta_21_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(21)
                                        elif self.clicker_zmiana_seta_22_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(22)
                                        elif self.clicker_zmiana_seta_23_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(23)
                                        elif self.clicker_zmiana_seta_24_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(24)
                                        elif self.clicker_zmiana_seta_25_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(25)
                                        elif self.clicker_zmiana_seta_26_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(26)
                                        elif self.clicker_zmiana_seta_27_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(27)
                                        elif self.clicker_zmiana_seta_28_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(28)
                                        elif self.clicker_zmiana_seta_29_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(29)
                                        elif self.clicker_zmiana_seta_30_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(30)
                                        elif self.clicker_zmiana_seta_31_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(31)
                                        elif self.clicker_zmiana_seta_32_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(32)
                                        elif self.clicker_zmiana_seta_33_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(33)
                                        elif self.clicker_zmiana_seta_34_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(34)
                                        elif self.clicker_zmiana_seta_35_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(35)
                                        elif self.clicker_zmiana_seta_36_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(36)
                                        elif self.clicker_zmiana_seta_37_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(37)
                                        elif self.clicker_zmiana_seta_38_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(38)
                                        elif self.clicker_zmiana_seta_39_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(39)
                                        elif self.clicker_zmiana_seta_40_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(40)
                                        elif self.clicker_zmiana_seta_41_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(41)
                                        elif self.clicker_zmiana_seta_42_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(42)
                                        elif self.clicker_zmiana_seta_43_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(43)
                                        elif self.clicker_zmiana_seta_44_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(44)
                                        elif self.clicker_zmiana_seta_45_lineedit.text() == f"{i+1}":
                                                lista_pozycji_zmiana_seta.append(45)

                                for x in range(self.miner_ustawienia_komendy_listwidget.count()):
                                        lista_komend.append(self.miner_ustawienia_komendy_listwidget.item(x).text())
                                
                                self.clicker_bind_clicker_lineedit.text()
                                self.clicker_bind_fakelag_lineedit.text()
                                self.clicker_bind_komenda_lineedit.text()
                                self.clicker_bind_sniezka_lineedit.text()
                                self.clicker_bind_zmiana_seta_lineedit.text()
                                self.clicker_opcje_sniezka_slot_miecz_lineedit.text()
                                self.clicker_opcje_sniezka_slot_sniezka_lineedit.text()
                                self.clicker_opcje_clicker_ms_slider.value()
                                self.clicker_opcje_garda_checkbox.isChecked()
                                self.clicker_opcje_garda_slider.value()
                                self.clicker_opcje_fakelag_checkbox.isChecked()
                                self.clicker_opcje_fakelag_slider.value()
                                self.clicker_opcje_zmiana_seta_checkbox.isChecked()
                                self.clicker_opcje_zmiana_seta_slider.value()
                                self.clicker_opcje_komenda_checkbox.isChecked()
                                self.clicker_opcje_komenda_lineedit.text()
                                self.clicker_opcje_sniezka_checkbox.isChecked()
                                self.clicker_opcje_jitter_checkbox.isChecked()
                                #self.clicker_opcje_podglad_checkbox.isChecked()
                                #self.clicker_opcje_aim_assist_checkbox.isChecked()
                                
                                self.miner_ustawienia_dlugosc_stowniarek_slider.value()
                                self.miner_ustawienia_szerokosc_stowniarek_slider.value()
                                self.miner_ustawienia_wpisywanie_komendy_slider.value()
                                self.miner_ustawienia_czas_m_komendami_slider.value()
                                self.miner_opcje_anty_rodzic_checkbox.isChecked()
                                self.miner_opcje_anty_rodzic_godzina_timeedit.text()
                                self.miner_opcje_tnt_logout_checkbox.isChecked()
                                self.miner_opcje_tnt_logout_sciezka_lineedit.text()
                                self.miner_opcje_kopanie_w_tle_checkbox.isChecked()
                                self.miner_opcje_kopanie_w_tle_bp_checkbox.isChecked()
                                self.miner_opcje_auto_rejoin_checkbox.isChecked()
                                self.miner_opcje_kontrola_zdalna_checkbox.isChecked()
                                
                                self.premium_passhunter_threads_slider.value()
                                self.premium_dehasher_threads_slider.value()
                                self.premium_keyword_scraper_threads_slider.value()
                                
                                values = [self.clicker_bind_clicker_lineedit.text(), self.clicker_bind_fakelag_lineedit.text(), self.clicker_bind_komenda_lineedit.text(), self.clicker_bind_sniezka_lineedit.text(), self.clicker_bind_zmiana_seta_lineedit.text(), self.clicker_opcje_sniezka_slot_miecz_lineedit.text(), self.clicker_opcje_sniezka_slot_sniezka_lineedit.text(), self.clicker_opcje_clicker_ms_slider.value(), self.clicker_opcje_garda_checkbox.isChecked(), self.clicker_opcje_garda_slider.value(), self.clicker_opcje_fakelag_checkbox.isChecked(), self.clicker_opcje_fakelag_slider.value(), self.clicker_opcje_zmiana_seta_checkbox.isChecked(), self.clicker_opcje_zmiana_seta_slider.value(), str(lista_pozycji_zmiana_seta), self.clicker_opcje_komenda_checkbox.isChecked(), self.clicker_opcje_komenda_lineedit.text(), self.clicker_opcje_sniezka_checkbox.isChecked(), self.clicker_opcje_jitter_checkbox.isChecked(), self.clicker_opcje_podglad_checkbox.isChecked(), self.clicker_opcje_aim_assist_checkbox.isChecked(), self.miner_ustawienia_dlugosc_stowniarek_slider.value(), self.miner_ustawienia_szerokosc_stowniarek_slider.value(), self.miner_ustawienia_wpisywanie_komendy_slider.value(), self.miner_ustawienia_czas_m_komendami_slider.value(), str(lista_komend), self.miner_opcje_anty_rodzic_checkbox.isChecked(), self.miner_opcje_anty_rodzic_godzina_timeedit.text(), self.miner_opcje_tnt_logout_checkbox.isChecked(), self.miner_opcje_tnt_logout_sciezka_lineedit.text(), self.miner_opcje_kopanie_w_tle_checkbox.isChecked(), self.miner_opcje_kopanie_w_tle_bp_checkbox.isChecked(), self.premium_passhunter_threads_slider.value(), self.premium_dehasher_threads_slider.value(), self.premium_keyword_scraper_threads_slider.value()]
                                config.save_config(values, config_name)
                        except:
                                pass

                elif mode == "add":
                        try:
                                if len(self.ustawienia_config_nazwa_lineedit.text()) > 0:
                                        config.create_config(self.ustawienia_config_nazwa_lineedit.text())
                                        self.ustawienia_config_lista_configow_listwidget.addItem(self.ustawienia_config_nazwa_lineedit.text())
                                        self.ustawienia_config_nazwa_lineedit.setText('')
                        ...
                        try:
                                os.remove(str(self.ustawienia_config_lista_configow_listwidget.currentItem().text()) + '.ini')
                                self.ustawienia_config_lista_configow_listwidget.removeItemWidget(self.ustawienia_config_lista_configow_listwidget.currentItem())
                                self.refresh_configs()
                        except:
                                pass
        ...
        def get_skin_name(self):
                try:
                        with open(f'{os.getenv("APPDATA")}/.minecraft/launcher_accounts.json') as lines:
                                for line in lines:
                                        if '"name"' in line:
                                                nickname = str(line.split(': ')[1]).split('"')[1]
                                                if os.path.exists(f'{nickname}.png') == True:
                                                        return nickname
                                                else:
                                                        response = requests.get(f'https://mskins.net/ru/search?q={nickname}&color=', data={'q': f'{nickname}'}).text
                                                        x = str(str(response.split('src="/uploads/preview')[1]).split('" alt="Minecraft')[0]).split('-')[0]
                                                        urllib.request.urlretrieve(f"https://mskins.net/uploads/preview{x}-600.png", f"img/{nickname}.png")
                                                        return nickname
                except Exception as e:
                        return 'steve'

        #def wysylanie_wiadomosci(self):
        #        n = 0
        #        czat = []
        #        while True:
        #                self.main_czat_wiadomosci_listwidget.clear()
        #                if len(czat) == 20:
        #                        czat.remove(czat[0])                                
        #                        czat.append(f'{n}')   
        #                else:
        #                        czat.append(f'{n}')
        #                for i in czat:
        #                        self.main_czat_wiadomosci_listwidget.addItem(i)
        #                #if self.main_czat_wiadomosci_listwidget.count() == 25:
        #                #if self.main_czat_wiadomosc_lineedit.text() == "":
        #                #        pass
        #                #else:
        #                #        self.main_czat_wiadomosci_listwidget.addItem(self.main_czat_wiadomosc_lineedit.text())
        #                #        self.main_czat_wiadomosc_lineedit.setText("")
        #                #self.main_czat_wiadomosci_listwidget.addItem(f"{n}")
        #                time.sleep(1)
        #                n += 1

        def load_discord_id(self):
                try:
                        key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                        api = security.API()
                        response = api.get_user_discord_id(username, key)
                        self.ustawienia_discord_id_lineedit.setText(str(response['discord_id']))
                except:
                        pass

        def save_discord_id(self):
                try:
                        key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                        api = security.API()
                        response = api.set_user_discord_id(username, self.ustawienia_discord_id_lineedit.text(), key)
                        if response['status'] == 'success':
                                self.ustawienia_discord_id_lineedit.setText('')
                                pvpb_alert.alert = 'Zapisano!'
                                pvpb_alert.alert_type = 'info'
                                pvpb_alert.open_alert()
                        else:
        ...
        def setupUi(self, MainWindow):
                ...
                "    image: url(img/checked_green.png);\n"
                "}")
                self.miner_opcje_kopanie_w_tle_bp_checkbox.clicked.connect(lambda: self.update_options('kopanie_w_tle_bp'))
                ...
                self.miner_opcje_auto_rejoin_checkbox.clicked.connect(lambda: self.update_options('auto_rejoin'))
                ...
                self.miner_ustawienia_dlugosc_stowniarek_slider.valueChanged.connect(lambda: self.update_options('dlugosc_stowniarek'))
                ...
                self.miner_ustawienia_szerokosc_stowniarek_slider.valueChanged.connect(lambda: self.update_options('szerokosc_stowniarek'))
                ...
                self.miner_ustawienia_wpisywanie_komendy_slider.valueChanged.connect(lambda: self.update_options('wpisywanie_komend'))
                ...
                self.miner_ustawienia_czas_m_komendami_slider.valueChanged.connect(lambda: self.update_options('czas_m_komendami'))
                ...
                self.miner_wykryte_okna_przywroc_pushbutton.clicked.connect(lambda: self.miner_przywracanie_okien())
                ...
                self.miner_wykryte_okna_podglad_pushbutton.clicked.connect(lambda: self.open_preview_window())
                ...
                "    background-color: rgb(10, 150, 10);\n"
                "}")
                self.premium_passhunter_threads_slider.valueChanged.connect(lambda: self.update_options('passhunter_threads'))
                ...
                self.premium_passhunter_start_pushbutton.clicked.connect(lambda: self.start_passhunter_process())
                ...
                self.premium_passhunter_stop_pushbutton.clicked.connect(lambda: self.start_passhunter('stop'))
                ...
                self.premium_passhunter_zaladuj_pushbutton.clicked.connect(lambda: self.start_passhunter('open'))
                ...
                "    background-color: rgb(10, 150, 10);\n"
                "}")
                self.premium_dehasher_threads_slider.valueChanged.connect(lambda: self.update_options('dehasher_threads'))
                ...
                self.premium_dehasher_start_pushbutton.clicked.connect(lambda: self.start_dehasher_process())
                ...
                self.premium_dehasher_stop_button.clicked.connect(lambda: self.start_dehasher('stop'))
                ...
                self.premium_dehasher_zaladuj_pushbutton.clicked.connect(lambda: self.start_dehasher('open'))
                ...
                "    background-color: rgb(10, 150, 10);\n"
                "}")
                self.premium_dork_generator_count_slider.valueChanged.connect(lambda: self.update_options('dork_generator_count'))
                ...
                "    background-color: rgb(10, 150, 10);\n"
                "}")
                self.premium_keyword_scraper_threads_slider.valueChanged.connect(lambda: self.update_options('keyword_scraper_threads'))
                ...
                f"    background-image: url(img/{skin_name}.png);\n"
                "    border: none;\n"
                "    background-color: none;\n"
                "}")
                ...
                self.ustawienia_config_usun_pushbutton.clicked.connect(lambda: self.config_manager('delete'))
                ...
                self.ustawienia_config_dodaj_pushbutton.clicked.connect(lambda: self.config_manager('add'))
                ...
                self.ustawienia_config_zapisz_pushbutton.clicked.connect(lambda: self.config_manager('save'))
                ...
                self.ustawienia_config_wczytaj_pushbutton.clicked.connect(lambda: self.config_manager('load'))
                ...
                self.ustawienia_discord_id_wczytaj_pushbutton.clicked.connect(lambda: self.load_discord_id())
                ...
                self.ustawienia_discord_id_zapisz_pushbutton.clicked.connect(lambda: self.save_discord_id())
                ...
                key = ''.join(random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for _ in range(12))
                s = security.API()
                s.set_online(username, key)
                threading.Thread(target=self.update_online_count).start()
                threading.Thread(target=self.update_stats_listwidget).start()
                threading.Thread(target=security.check_for_debuggers).start()
        ...
        def retranslateUi(self, MainWindow):
                ...
                MainWindow.setWindowTitle(_translate("MainWindow", "pvpbooster v1.0"))
                self.main_witaj_nick_label.setText(_translate("MainWindow", f"Witaj, {username}"))
                ...
                self.main_plan_label.setText(_translate("MainWindow", f"Plan: {license_type}"))
                self.main_licencja_label.setText(_translate("MainWindow", f"Licencja: {license_expire}"))
                ...
                self.premium_passhunter_label.setText(_translate("MainWindow", "PassHunter"))
                self.premium_passhunter_threads_label.setText(_translate("MainWindow", "Wątki: 1"))
                self.premium_passhunter_adresy_label.setText(_translate("MainWindow", "Adresy email: 0"))
                self.premium_passhunter_znalezione_label.setText(_translate("MainWindow", "Znalezione hasła: 0"))
                ...
                self.premium_dehasher_label.setText(_translate("MainWindow", "Dehasher"))
                self.premium_dehasher_threads_label.setText(_translate("MainWindow", "Wątki: 1"))
                self.premium_dehasher_zaszyfrowane_hasla_label.setText(_translate("MainWindow", "Zaszyfrowane hasła: 0"))
                self.premium_dehasher_znalezione_hasla_label.setText(_translate("MainWindow", "Znalezione hasła: 0"))
                ...
                self.premium_dork_generator_label.setText(_translate("MainWindow", "Dork Generator"))
                self.premium_dork_generator_count_label.setText(_translate("MainWindow", "Ilość: 0"))
                ...
                self.premium_keyword_scraper_label.setText(_translate("MainWindow", "Keyword Scraper"))
                self.premium_keyword_scraper_threads_label.setText(_translate("MainWindow", "Wątki: 1"))
                self.premium_keyword_scraper_bazowe_slowa_label.setText(_translate("MainWindow", "Bazowe słowa: 0"))
                self.premium_keyword_scraper_znalezione_label.setText(_translate("MainWindow", "Znalezione słowa: 0"))
